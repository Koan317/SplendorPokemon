...
if (el.btnConfirmMasterBall) el.btnConfirmMasterBall.addEventListener("click", () => resolveMasterBallConfirm(true));
if (el.btnCancelMasterBall) el.btnCancelMasterBall.addEventListener("click", () => resolveMasterBallConfirm(false));
